...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-semibold py-3 mb-4"><span class="text-muted fw-light"> Tambah Data Tipe Pegawai</h4>
        ...
        <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <form action="<?= base_url('DataTipeController/tambahTipe') ?>" method="post">
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
