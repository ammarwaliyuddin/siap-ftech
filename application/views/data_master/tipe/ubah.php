...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-semibold py-3 mb-4"><span class="text-muted fw-light"> Ubah Data Tipe Pegawai</h4>
        ...
        <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <input type="hidden" name="id_tipe" id="id_tipe" value="<?php echo $tipe['id_tipe'];?>">
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
