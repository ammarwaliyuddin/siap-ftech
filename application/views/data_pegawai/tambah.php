                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <select class="form-select" id="id_pendidikan" name="id_pendidikan" aria-label="Default select example">
                                ...
                                <option value="<?php echo $pk->id_pendidikan?>"><?php echo $pk->strata.'-'.$pk->jurusan?></option>
                                <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">No Ijazah</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"
                              ...
                              <input
                                ...
                                aria-label="Masukkan nomor Ijazah"
                                aria-describedby="basic-icon-default-fullname2"
                              />
