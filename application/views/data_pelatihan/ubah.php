...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-semibold py-3 mb-4"><span class="text-muted fw-light"> Ubah Data Pelatihan</h4>
        ...
        <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <?= form_open_multipart(); ?>
                    <input type="hidden" name="id_pelatihan" id="id_pelatihan" value="<?php echo $pelatihan['id_pelatihan'];?>">
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                ...
                                id="nama_pelatihan"
                                name="nama_pelatihan"
                                value="<?php echo $pelatihan['nama_pelatihan'];?>"
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <select class="form-select" id="id_pegawai" name="id_pegawai" aria-label="Default select example">
                                ...
                                <option value="<?php echo $peg->id_pegawai?>"<?php if($peg->id_pegawai == $pelatihan['id_pelatihan']){echo "selected";} ?>><?php echo $peg->nama_pegawai?> </option>
                                <?php endforeach; ?> 
                                </select>
                            </div>
                          </div>
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                ...
                                id="jam_pelatihan"
                                name="jam_pelatihan"
                                value="<?php echo $pelatihan['jam_pelatihan'];?>"
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                ...
                                id="tanggal"
                                name="tanggal"
                                value="<?php echo $pelatihan['tanggal'];?>"
                    ...
                    <h5 class="card-header">File Pelatihan</h5>
                      ...
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        <input type="text" class="form-control" disabled value="<?php echo $pelatihan['file'];?>" id="file">
